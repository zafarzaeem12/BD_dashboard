...
import { approveDisapprove, blockUnblock, deleteAccount, getAllEmployees, getAllUsers, getEmployersRequest, getUserStatus } from '../store/slices/userSlice';
            ...
            >
                <div className='change-password-modal' id="exampleModalCenter" tabIndex={-1} aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style={{ display: "block", zIndex: 100 }}>
                    {modalType == "userDetail" ? <>
                        <p className="pass-text">Employee Detail</p>
                                            ...
                                            <table id="tableData" className="table table-bordered" style={{ width: '100%', textAlign: "center" }}>
                                                ...
                                                <tfoot>
                                                    {users ? (<tr>
                                                        ...
                                                        <th>Detail</th>
                                                        <th>Action</th> */}
                                                    </tr>) : (<tr><th>{status == "loading" ? "Loading..." : "No Employee Found"}</th></tr>)}
                                                </tfoot>
                                            </table>
                                        </div>
                                    </div>
