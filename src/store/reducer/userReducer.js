  ...
  builder
    ...
    .addCase(signinUser.fulfilled, (state, action) => {
      ...
      axios.defaults.headers.common[
        "Authorization"
      ] = `Bearer ${action.payload.data.user_authentication}`;
    ...
    .addCase(dashboard.fulfilled, (state, action) => {
      ...
      state.dashboard = {
        iosCount: action.payload.data.ios,
        androidCount: action.payload.data.android,
    ...
    // delete Category
    .addCase(categorydeleted.pending, (state, action) => {
      state.status = "loading";
    })
    ...
    .addCase(categorydeleted.rejected, (state, action) => {
      state.status = "failed";
      state.error = action.payload.message;
      toast.error(action.payload.message, {
        position: toast.POSITION.TOP_RIGHT,
